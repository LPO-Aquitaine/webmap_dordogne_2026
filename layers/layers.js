...
lyr_GoogleSatelliteHybrid_0.setVisible(false);lyr_OSMStandard_1.setVisible(true);lyr_Limitesdescommunes_2.setVisible(true);lyr_Maillesprospectesen2022etou2023etou2024etou2025_3.setVisible(true);lyr_MaillesprospecterpourlenquteHirondelles_4.setVisible(true);lyr_Autresdonnesantrieures_5.setVisible(true);lyr_Donnesdelenqute2025_6.setVisible(true);
...
lyr_MaillesprospecterpourlenquteHirondelles_4.set('fieldLabels', {'Identifian': 'header label - visible with data', 'CODE_POST': 'inline label - visible with data', 'NOM': 'inline label - visible with data', 'NOM_2': 'inline label - visible with data', });
